...
function constructLinks() {
  return (
    <ul className="navigation">
      ...
      <li>
        <NavLink to="/minimal-size">Pane Minimal Size</NavLink>
      </li>
      <li>
        <NavLink to="/percentage">Width in Percentage</NavLink>
      </li>
      <li>
        <NavLink to="/nested">Nested Layout</NavLink>
      </li>
    </ul>
  );
}
...
function App(props) {
  return (
    <div>
      ...
      <div className="main">
        <nav className="navigation-bar">{constructLinks()}</nav>
